  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0d0d0d', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ width: 380, background: '#111111', border: '1px solid #1a1a1a', borderRadius: 12, padding: '36px 32px' }}>
        ...
        <p style={{ margin: '0 0 28px', fontSize: 14, color: '#6b7280' }}>Join PotholeDetect</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" style={{ width: '100%', padding: '11px', background: '#6366f1', color: '#fff', border: 'none', borderRadius: 7, fontWeight: 600, fontSize: 14, cursor: 'pointer' }}>
            Create Account
          </button>
        </form>
